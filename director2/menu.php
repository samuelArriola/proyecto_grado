...
<li><a class="black-text" style="font-size: 0.8em; text-align: center; height: 64px;">
  <i class="material-icons teal-text" style="height: 16px; line-height: 48px;">group</i>Coodinadores
</a></li>
<li><a class="black-text" id="mnuProy" style="font-size: 0.8em; text-align: center; height: 64px;">
...
<li><a href="javascript: $('.sidenav').sidenav('close');" style="padding-left: 16px;">
  <i class="material-icons teal-text">group</i>Usuarios</a>
</li>
<li><a href="javascript: $('.sidenav').sidenav('close');" style="padding-left: 16px;">
